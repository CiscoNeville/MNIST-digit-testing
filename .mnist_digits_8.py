...
parser.add_argument('--visualize_errors', action='store_true', help='Show first 20 misclassified test images')
...
if args.visualize_errors and misclassified_samples:
